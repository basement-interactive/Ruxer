...
import {recordCaptureSource} from '@app/native-screenshare';
	...
	({
		...
		const handleStartSelection = useCallback(
			async (cardId: string) => {
				...
				// Tauri desktop: record the picked source so the getDisplayMedia
				// override captures exactly this monitor/window natively (no
				// WebView2 dialog). No-op on web (id is ignored there).
				recordCaptureSource(cardId);
